...
class Grille :
	...
	def estValide(self, numBat, x, y):
		...
		#Resultat: Renvoie True si verificationCoordonnees est true et si la position indiquée par (x,y) est juxtaposée à un bateau de même numéro, renvoie False sinon
		#Post-conditions: bool
